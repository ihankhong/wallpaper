...
<body>
    <article class="container">
        ...
        {{--  banner start  --}}
        <div class="mb-4"><img src="{{ asset('images/WD-01.jpg') }}" class="img-fluid" alt="Banner image"></div>
        {{--  banner end  --}}
        {{--  品牌精神 start  --}}
        <div class="card mb-4">
            <img src="{{ asset('images/WD-02.jpg') }}" class="card-img-top" alt="品牌精神">
            <div class="card-body">
                <h1 class="card-title text-center"><span class="title px-3 py-3">為了更豐富，更舒適的生活</span></h1>
                <h1 class="card-text fo-c1">在工作空間中，實用性和功能性。專為商店和出色的可維護性而設計。在娛樂和文化的空間，新鮮和復雜。考慮醫療和福利設施的衛生和安全。在日常生活中的所有情況下，室內都需要各種角色。睡覺，放鬆，工作，玩耍，醫治。我想創造一個包含我們所有生活場景的更加豐富的環境。我們Sincol集團追求內飾作為一種生活方式的提高，並為所有的空間提供舒適和愉悅。</h1>
            </div>
        </div>
        {{--  品牌精神 end  --}}
        {{--  歷史定位 start  --}}
            ...
            <div class="row no-gutters">
                <div class="col-md-6">
                    <div class="p-0 px-md-35 py-md-35 bg">
                        <img src="{{ asset('images/WD-03.jpg') }}" class="card-img" alt="歷史定位">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="card-body">
                        <h2 class="card-title text-center"><span class="title px-3 py-3">享受壁紙帶來的裝飾性與功能</span></h2>
                        <h2 class="card-text fo-c2">為了應對空間設計日益增長的需求，設計出一本豐富的材料變化與優良的品質壁紙書，傳播空間變化的可能性與壁紙使用的多樣化。人們試圖通過各種方式在居住，裝飾和內部的地方尋求舒適和美感。例如，平安時代的古坑房屋壁畫，日本榻榻米和折疊屏風等。這些是人們在生活中創造的日常室內裝飾，今天仍然是一種文化。在任何時代，都有一個以壁紙裝飾著自己的室內空間，得到更好的放鬆，舒適和美麗空間。我們要創造一個包含生命的內部空間，並不斷地為時代和人們的興趣和目的提供各種形式。我們的Sincol集團為實現更加豐富和舒適的生活而廣泛活躍，並將室內創作視為一種生活文化。</h2>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="card mb-4">
            <div class="p-0 px-md-35 py-md-35">
                <div class="wrapper">
                    <img src="{{ asset('images/WD-04.jpg') }}" class="card-img" alt="品牌特色">
                    <div class="wrapper-a">
                        <div class="content-box">
                            <div class="flex-row">
                                <div class="col-md-8 offset-md-2 col-lg-6 offset-lg-3 bg-white px-3 py-3">
        ...
        <div class="card mb-4">
            <div class="row no-gutters">
                <div class="col-md-6">
                    <div class="p-0 px-md-35 py-md-35 bg">
                        <img src="{{ asset('images/WD-05.jpg') }}" class="card-img" alt="經典風格">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="card-body">
        ...
        <div class="card mb-4">
            <div class="p-0 px-md-35 py-md-35">
                <div class="wrapper">
                    <img src="{{ asset('images/WD-06.jpg') }}" class="card-img" alt="案例">
                    <div class="wrapper-a">
                        <div class="content-box justify-content-end">
                            <div class="flex-row">
                                <div class="col-md-6 offset-md-5 col-lg-6 offset-lg-5 col-xl-7 offset-xl-4 bg-white px-3 py-3">
            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-6 col-sm-6 col-md-3">
                        <img src="{{ asset('images/WD-07.jpg') }}" class="card-img" alt="特殊壁紙1">
                        <p class="card-text fo-c1 text-center mb-3 mb-md-0">植絨纖維</p>
                    </div>
                    <div class="col-6 col-sm-6 col-md-3">
                        <img src="{{ asset('images/WD-08.jpg') }}" class="card-img" alt="特殊壁紙2">
                        <p class="card-text fo-c1 text-center mb-3 mb-md-0">施華洛世奇水晶</p>
                    </div>
                    <div class="col-6 col-sm-6 col-md-3">
                        <img src="{{ asset('images/WD-09.jpg') }}" class="card-img" alt="特殊壁紙3">
                        <p class="card-text fo-c1 text-center mb-3 mb-md-0">反光材質-雲母，沙子</p>
                    </div>
                    <div class="col-6 col-sm-6 col-md-3">
                        <img src="{{ asset('images/WD-10.jpg') }}" class="card-img" alt="特殊壁紙4">
                ...
                <div class="bg px-0 pr-md-0 pl-md-4">
                    <div class="row no-gutters">
                        <div class="col-md-7 col-lg-8">
                            <img src="{{ asset('images/WD-11.jpg') }}" class="card-img" alt="未來展望">
                        </div>
