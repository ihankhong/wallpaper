...
<body>
    <article class="container">
        ...
        {{--  banner start  --}}
        <div class="mb-4">
            <a href="#"><img src="{{ asset('images/WD-01.jpg') }}" class="img-fluid" alt="Banner image"></a>
        </div>
        {{--  banner end  --}}
        {{--  品牌精神 start  --}}
        <div class="card mb-4">
            <a href="#"><img src="{{ asset('images/WD-02.jpg') }}" class="card-img-top" alt="品牌精神"></a>
            ...
            <div class="row no-gutters">
                <div class="col-md-6">
                    <div class="p-0 px-md-35 py-md-35 bg">
                        <a href="#"><img src="{{ asset('images/WD-03.jpg') }}" class="card-img" alt="歷史定位"></a>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="card-body pt-65 pt-md-35">
        ...
        <div class="card mb-4">
            <div class="p-0 px-md-35 py-md-35">
                <div class="wrapper">
                    <a href="#"><img src="{{ asset('images/WD-04.jpg') }}" class="card-img" alt="品牌特色"></a>
                    <div class="wrapper-a">
        ...
        <div class="card mb-4">
            <div class="row no-gutters">
                <div class="col-md-6">
                    <div class="p-0 px-md-35 py-md-35 bg">
                        <a href="#"><img src="{{ asset('images/WD-05.png') }}" class="card-img" alt="經典風格"></a>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="card-body pt-65 pt-md-35">
        ...
        <div class="card mb-4">
            <div class="p-0 px-md-35 py-md-35">
                <div class="wrapper">
                    <a href="#"><img src="{{ asset('images/WD-06.png') }}" class="card-img" alt="案例"></a>
                    <div class="wrapper-a">
            ...
            <div class="card-body pt-65">
                ...
                <div class="row">
                    <div class="col-6 col-sm-6 col-md-3">
                        <a href="#"><img src="{{ asset('images/WD-07.jpg') }}" class="card-img" alt="特殊壁紙1"></a>
                        <p class="card-text fo-c1 text-center mb-3 mb-md-0">植絨纖維</p>
                    </div>
                    <div class="col-6 col-sm-6 col-md-3">
                        <a href="#"><img src="{{ asset('images/WD-08.jpg') }}" class="card-img" alt="特殊壁紙2"></a>
                        <p class="card-text fo-c1 text-center mb-3 mb-md-0">施華洛世奇水晶</p>
                    </div>
                    <div class="col-6 col-sm-6 col-md-3">
                        <a href="#"><img src="{{ asset('images/WD-09.jpg') }}" class="card-img" alt="特殊壁紙3"></a>
                        <p class="card-text fo-c1 text-center mb-3 mb-md-0">反光材質-雲母，沙子</p>
                    </div>
                    <div class="col-6 col-sm-6 col-md-3">
                        <a href="#"><img src="{{ asset('images/WD-10.jpg') }}" class="card-img" alt="特殊壁紙4"></a>
                ...
                <div class="bg px-0 pr-md-0 pl-md-4">
                    <div class="row no-gutters">
                        <div class="col-md-7 col-lg-8">
                            <a href="#"><img src="{{ asset('images/WD-11.png') }}" class="card-img" alt="未來展望"></a>
                        </div>
